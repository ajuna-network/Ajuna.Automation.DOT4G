...
namespace AjunaNET.NetApiExt.Generated.Model.pallet_treasury
{
    
    
    /// <summary>
    /// >> 238 - Composite[pallet_treasury.Proposal]
    /// </summary>
    ...
    public sealed class Proposal : BaseType
    {
        ...
        /// >> proposer
        /// </summary>
        private AjunaNET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 _proposer;
        ...
        /// >> beneficiary
        /// </summary>
        private AjunaNET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 _beneficiary;
        ...
        public AjunaNET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 Proposer
        {
            get
            {
        ...
        public AjunaNET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 Beneficiary
        {
            get
            {
        ...
        {
            var start = p;
            Proposer = new AjunaNET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32();
            Proposer.Decode(byteArray, ref p);
            Value = new Ajuna.NetApi.Model.Types.Primitive.U128();
            Value.Decode(byteArray, ref p);
            Beneficiary = new AjunaNET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32();
